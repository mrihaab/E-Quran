          ...
          <div className="bg-linear-to-r from-purple-600 to-purple-500 rounded-2xl p-8 relative overflow-hidden shadow-xl shadow-purple-600/30">
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="flex gap-4 mt-6">
                <button onClick={() => navigate('/admin-analytics')} className="px-6 py-3 bg-white text-purple-600 font-bold rounded-lg hover:bg-slate-50 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
                  System Overview
                </button>
                ...
                {[
                  ...
                  <div key={i}>
                    ...
                    <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                      <div className={`h-full rounded-full transition-all ${metric.color === 'green' ? 'bg-green-500' :
