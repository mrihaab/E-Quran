    ...
    <header className="sticky top-0 z-50 w-full border-b border-primary/10 bg-white/80 backdrop-blur-md px-4 sm:px-6 md:px-20 py-3 sm:py-4">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button onClick={() => navigate('/sign-up')} className="rounded-full bg-primary px-4 sm:px-6 py-2 sm:py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all">
            Sign Up
          </button>
        </div>
